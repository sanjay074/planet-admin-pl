...
const BrandList = () => {
  ...
  const handleEdit = (offer) => {
    ...
    setEditForm({
      name: offer.name, // Set the name
      pic: [offer.pic][0] // Clear pic initially, handled separately
    });
    setImagePreviews([offer.pic]); // Set the image preview for the modal
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-lg">
            ...
            <div className="w-full mt-5">
              <input
                type="text"
                name="name"
                value={editForm.name} // Prefill the name input
            ...
            <div className="mt-5">
              ...
              <div className="flex gap-4">
                ...
                {imagePreviews.length > 0 && (
                  <div className="w-24 h-24 border-2 relative">
                    <img
                      src={imagePreviews[0]} // Display the image preview
                      alt="Preview"
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        setImagePreviews([]); // Clear the preview on removal
                        setEditForm((prevForm) => ({
                          ...prevForm,
                          pic: "" // Reset the form pic field
                        }));
                      }}
