...
export const OrderDetails = () => {
    ...
    return (
        <div className="flex justify-center py-8 bg-gray-100 mt-12">
            <div className="flex flex-col lg:flex-row bg-white max-w-6xl w-full rounded-lg shadow-lg overflow-hidden">
